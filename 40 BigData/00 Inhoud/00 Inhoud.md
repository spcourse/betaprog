...
1. Leer een [data-set](/python/files) analyseren en vewerken

2. <span class="label label-primary">Opdracht</span> Verwerk sensor-data van een  [autorit](/bigdata/dataverwerken)
